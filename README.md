# Преддипломная практика. Иванов Н.Ю
...
**Сравнительный анализ технологии Web Components и современных фронтенд-фреймворков для разработки пользовательских интерфейсов** (Экспериментальная проверка гипотез)
